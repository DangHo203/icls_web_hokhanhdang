...
export default function Register() {
    ...
    return (
        <div className="w-screen h-screen flex flex-col grow justify-center py-5     items-center text-black bg-[#F4F7FF] max-md:px-5 max-md:py-24 max-md:max-w-full">
            <div
                className="wow fadeInUp relative mx-auto h-auto w-1/3 overflow-hidden rounded-lg bg-white py-14 px-8 text-center sm:px-12 md:px-[60px]"
                data-wow-delay=".15s"
            >
                ...
                <span className="text-[35px] font-bold">Sign In</span>
                <form>
